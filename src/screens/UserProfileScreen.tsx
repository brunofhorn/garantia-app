...
function ProfileRow({ icon, title, subtitle }: { icon: keyof typeof Feather.glyphMap; title: string; subtitle: string }) {
  return (
    <TouchableOpacity activeOpacity={0.85} className="mb-2 flex-row items-center rounded-xl border border-[#1F2C45] bg-[#0F1A2E] px-3 py-3">
      <View className="h-10 w-10 items-center justify-center rounded-lg bg-[#132746]">
        <Feather name={icon} size={18} color="#4FA0FF" />
      </View>
      ...
      <ScrollView className="flex-1 px-4" contentContainerStyle={{ paddingBottom: 110 }} showsVerticalScrollIndicator={false}>
        <View className="mt-4 items-center rounded-xl border border-[#1F2C45] bg-[#0F1A2E] p-4">
          <View className="relative">
            <View className="h-24 w-24 items-center justify-center rounded-full bg-[#123250]">
              <Feather name="user" size={44} color="#8BD9FF" />
            </View>
            <TouchableOpacity className="absolute -bottom-1 -right-1 h-8 w-8 items-center justify-center rounded-full border-2 border-[#060D1A] bg-[#1F9CFF]">
              <Feather name="edit-2" size={14} color="#031529" />
            </TouchableOpacity>
          </View>
          ...
          <View className="mt-4 w-full flex-row justify-between">
            <View className="w-[31.5%] items-center rounded-xl border border-[#24354F] bg-[#0C182B] p-3">
              <Text className="text-[22px] font-bold text-[#4FA0FF]">
                Jan{`\n`}2023
              </Text>
              <Text className="mt-1 text-center text-[9px] font-bold tracking-[1px] text-[#7E8FA8]">
                MEMBRO{`\n`}DESDE
              </Text>
            </View>
            <View className="w-[31.5%] items-center rounded-xl border border-[#24354F] bg-[#0C182B] p-3">
              <Text className="text-[24px] font-bold text-[#4FA0FF]">24</Text>
              <Text className="mt-1 text-center text-[9px] font-bold tracking-[1px] text-[#7E8FA8]">GARANTIAS</Text>
            </View>
            <View className="w-[31.5%] items-center rounded-xl border border-[#24354F] bg-[#0C182B] p-3">
              <Text className="text-[24px] font-bold text-[#4FA0FF]">R$ 1.2k</Text>
              <Text className="mt-1 text-center text-[9px] font-bold tracking-[1px] text-[#7E8FA8]">ECONOMIA</Text>
            </View>
          </View>
        </View>
        ...
        <TouchableOpacity
          ...
          className="mt-3 h-12 flex-row items-center justify-center rounded-xl border border-[#5F2530] bg-[#3A1A22]"
        >
