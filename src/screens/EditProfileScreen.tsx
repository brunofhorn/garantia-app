    ...
    <View className="flex-1 bg-appBg">
      ...
      <View className="flex-1 px-4 pt-5">
        ...
        <AnimatedEntrance delay={120}>
          <InputField label="E-mail" placeholder="joao.silva@email.com" />
        </AnimatedEntrance>
        <AnimatedEntrance delay={160}>
          <InputField label="Telefone" placeholder="(11) 98765-4321" />
        </AnimatedEntrance>
      </View>
      ...
      <View className="mx-4 mb-4 flex-row items-center rounded-2xl bg-[#16A34A] p-4" style={{ elevation: 2 }}>
